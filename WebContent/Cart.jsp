...
<body>
<h1 align="center">购物车界面</h1>
  <a href="index.jsp">返回主页</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="index_Shopping.jsp">返回购物页面</a><br>
   <p>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <img src="cart.jpg" height="60px" width="60px">已采购${sumnum}本书籍</p>
    ...
    <tr align="center">
        	...
        	<td><a href="DeleteServlet?id=${GIL.getId()}">删除</a></td>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="ShoppingList.jsp">确认订单</a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="GoodsInfoServlet?type=shoppingInit">清空购物车</a>
